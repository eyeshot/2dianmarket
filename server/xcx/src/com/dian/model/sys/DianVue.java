...
import com.dian.model.sys.param.DianParameter;
...
public class DianVue extends DianParameter {
	...
	private DianType forestryType; // 种类
	...
	public DianType getForestryType() {
		return forestryType;
	}

	public void setForestryType(DianType forestryType) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final DianVue other = (DianVue) obj;
